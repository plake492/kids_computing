...
export var cornify_count = 0;
export var cornify_add = function (options?: any) {
...
export var cornify_updatecount = function () {
  if (typeof window !== 'undefined') {
    var id = '__cornify_count';
    var p = document.getElementById(id);

    if (p === null) {
      var p: HTMLElement | null = document.createElement('p');
      p.id = id;
...
export var cornify_setcookie = function (name: any, value: any, days: any) {
  if (typeof window !== 'undefined') {
    var d = new Date();
...
export var cornify_getcookie = function (cname?: any) {
  if (typeof window !== 'undefined') {
    var name = cname + '=';
...
export var cornify_replace = function () {
  if (typeof window !== 'undefined') {
    // Replace text.
    var hc = 6;
    var hs;
...
export var cornify_click_cupcake_button = function () {
  if (typeof window !== 'undefined') {
    var doc = document;
...
export var cornify_add_cupcake_button = function () {
  if (typeof window !== 'undefined') {
